...
class PromptManager:
    ...
    # Modificar el método _get_strict_system_prompt para agregar manejo especial de consultas sobre tipos
    def _get_strict_system_prompt(self) -> str:
        """Prompt estricto para máxima precisión"""
        return """Eres un analista legal de {hotel_group} especializado en contratos.
            ...
            - Si la pregunta es sobre "qué tipos de contratos" o similar, DEBES:
            a) Revisar TODOS los fragmentos proporcionados
            b) Identificar CADA tipo diferente mencionado
            c) Listar TODOS los tipos únicos encontrados
            d) Los tipos comunes incluyen: arrendamiento, gestión hotelera, franquicia, servicios, mantenimiento
            e) Si un fragmento menciona un tipo específico, INCLÚYELO en tu respuesta
